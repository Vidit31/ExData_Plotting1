...
plot(p1$Time, p1$Global_active_power, ylab = "Global Active Power", xlab = "", type="n")
lines(p1$Time, p1$Global_active_power, type="l", col = 'black')
plot(p1$Time, p1$Voltage, ylab = "Voltage", xlab = "datetime", type="n")
lines(p1$Time, p1$Voltage, type="l", col = 'black')
...
plot(p1$Time, p1$Global_reactive_power, ylab = "Global_reactive_power", xlab = "datetime", type="n")
lines(p1$Time, p1$Global_reactive_power, type="l", col = 'black')
dev.off()